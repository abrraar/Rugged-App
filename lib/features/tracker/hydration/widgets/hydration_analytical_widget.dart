...
class HydrationAnalyticalGraph extends StatefulWidget {
  ...
  const HydrationAnalyticalGraph({
    super.key,
    required this.dates,
    required this.data,
  ...
  @override
  State<HydrationAnalyticalGraph> createState() => _HydrationAnalyticalGraphState();
}

class _HydrationAnalyticalGraphState extends State<HydrationAnalyticalGraph> {
  ...
  @override
  void didUpdateWidget(HydrationAnalyticalGraph oldWidget) {
          ...
          if (hasSelection)
            Padding(
              ...
              child: Row(
                ...
                children: [
                  _buildStatMini("WATER INTAKE", widget.data["water"]?[_currentIndex], Colors.blueAccent, isCompact),
                ],
              ),
            ),
        ...
        children: [
          ...
          IconButton(
            ...
            icon: Icon(
              ...
              color: isFiltered ? Colors.orangeAccent : Colors.blueAccent,
          ...
          Widget buildFilterOption({
            ...
            return GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: isSelected ? Colors.blueAccent.withValues(alpha: 0.1) : AppColors.background.withValues(alpha: 0.5),
                  borderRadius: BorderRadius.circular(isCompact ? 16.r : 12.0),
                  border: Border.all(
                    color: isSelected ? Colors.blueAccent : AppColors.white.withValues(alpha: 0.05),
                    width: 1.5,
                  ),
                ),
                child: Row(
                  children: [
                    Icon(
                      ...
                      color: isSelected ? Colors.blueAccent : AppColors.textSecondary.withValues(alpha: 0.3),
                      size: isCompact ? 20.r : 18.0,
                    ),
                              ...
                              Row(
                                children: [
                                  Container(
                                    ...
                                    child: Icon(Icons.tune_rounded, color: Colors.blueAccent, size: isSheetCompact ? 24.r : 20.0),
                                  ),
        ...
        return Theme(
          data: Theme.of(ctx).copyWith(
            colorScheme: ColorScheme.dark(
              ...
              secondaryContainer: Colors.blueAccent.withValues(alpha: 0.25),
            ...
            datePickerTheme: DatePickerThemeData(
              ...
              backgroundColor: AppColors.surface,
              rangeSelectionBackgroundColor: Colors.blueAccent.withValues(alpha: 0.25),
              ...
              dayOverlayColor: WidgetStateProperty.all(Colors.blueAccent.withValues(alpha: 0.1)),
            ),
          ),
          child: Dialog(
...
class HydrationComparisonWidget extends StatelessWidget {
  final int? idx1;
  final int? idx2;
  final List<DateTime> dates;
  final Map<String, List<double?>> data;
  ...
  const HydrationComparisonWidget({
    super.key,
    required this.idx1,
    required this.idx2,
    required this.dates,
  ...
  Widget _buildIntervalHeader(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          const Icon(Icons.timer_outlined, color: Colors.blueAccent, size: 12.0),
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text(title, style: AppTextStyles.labelSmall.adaptive(context).copyWith(color: selectedIdx != null ? Colors.blueAccent : AppColors.textSecondary.withValues(alpha: 0.4), fontWeight: FontWeight.w500, letterSpacing: 2)),
              if (selectedIdx != null && !isEnd) ...[
                SizedBox(width: isCompact ? 8.w : 6.0),
                GestureDetector(
                  onTap: () => onChanged(null),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: selectedIdx != null ? Colors.blueAccent.withValues(alpha: 0.05) : AppColors.surfaceLight.withValues(alpha: 0.3),
                borderRadius: BorderRadius.circular(isCompact ? 12.r : 10.0),
                border: Border.all(color: selectedIdx != null ? Colors.blueAccent.withValues(alpha: 0.4) : AppColors.white.withValues(alpha: 0.05)),
              ),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Icon(selectedIdx != null ? Icons.event_available_rounded : Icons.event_note_rounded, color: Colors.blueAccent, size: isCompact ? 18.r : 16.0),
              ...
              Widget buildChip({required String label, required bool isSelected, required VoidCallback onTap}) {
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: isSelected ? Colors.blueAccent.withValues(alpha: 0.15) : AppColors.surfaceLight.withValues(alpha: 0.3),
                              ...
                              Row(
                                children: [
                                  Container(
                                    padding: EdgeInsets.all(isSheetCompact ? 10.r : 8.0),
                                    decoration: BoxDecoration(color: Colors.blueAccent.withValues(alpha: 0.1), shape: BoxShape.circle),
                                    child: Icon(Icons.event_note_rounded, color: Colors.blueAccent.withValues(alpha: 0.5), size: isSheetCompact ? 24.r : 20.0),
                                  ),
                                  SizedBox(width: isSheetCompact ? 16.w : 12.0),
                                  Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text("SELECT RECORDING", style: AppTextStyles.h3.adaptive(context)),
                                      Text("CHOOSE A DATE FROM YOUR HISTORY", style: AppTextStyles.labelSmall.adaptive(context).copyWith(color: AppColors.textSecondary.withValues(alpha: 0.5), letterSpacing: 1)),
                                    ],
                                  ),
                                ],
                              ),
                                    ...
                                    itemBuilder: (context, i) {
                                      ...
                                      return GestureDetector(
                                                                  ...
                                                                  Row(
                                                                    children: [
                                                                      Container(
                                                                        ...
                                                                        decoration: BoxDecoration(color: Colors.blueAccent.withValues(alpha: 0.1), shape: BoxShape.circle),
                                                                        child: Icon(Icons.access_time_rounded, color: Colors.blueAccent, size: isTimeSheetCompact ? 24.r : 20.0),
                                                                      ),
                                                                  ...
                                                                  itemBuilder: (context, idxPos) {
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child: AnimatedContainer(
                                                                        ...
                                                                        decoration: BoxDecoration(
                                                                          color: isCurrent ? Colors.blueAccent.withValues(alpha: 0.1) : AppColors.background.withValues(alpha: 0.5),
                                                                          borderRadius: BorderRadius.circular(isTimeSheetCompact ? 16.r : 12.0),
                                                                          border: Border.all(
                                                                            color: isCurrent ? Colors.blueAccent : (isOther ? Colors.blueAccent.withValues(alpha: 0.3) : AppColors.white.withValues(alpha: 0.05)),
                                                                            width: 1.5,
                                                                          ),
                                                                        ),
                                                                        child: Row(
                                                                          children: [
                                                                            Icon(
                                                                              ...
                                                                              color: isCurrent ? Colors.blueAccent : (isOther ? AppColors.textSecondary.withValues(alpha: 0.5) : AppColors.textSecondary.withValues(alpha: 0.2)),
                                        ...
                                        child: AnimatedContainer(
                                          ...
                                          decoration: BoxDecoration(
                                            color: isPartiallySelected ? Colors.blueAccent.withValues(alpha: 0.1) : AppColors.background.withValues(alpha: 0.5),
                                            borderRadius: BorderRadius.circular(isSheetCompact ? 16.r : 12.0),
                                            border: Border.all(
                                              color: isPartiallySelected ? Colors.blueAccent : (isOccupiedByOther ? Colors.blueAccent.withValues(alpha: 0.3) : AppColors.white.withValues(alpha: 0.05)),
                                              width: 1.5,
                                            ),
                                          ),
                                          child: Row(
                                            children: [
                                              Icon(
                                                ...
                                                color: isPartiallySelected ? Colors.blueAccent : (isOccupiedByOther ? Colors.blueAccent.withValues(alpha: 0.5) : AppColors.textSecondary.withValues(alpha: 0.2)),
  ...
  Widget _buildComparisonDetails(BuildContext context) {
    ...
    final v1 = data["water"]?[idx1!];
    final v2 = data["water"]?[idx2!];
    if (v1 != null && v2 != null) {
      items.add(_buildMetricComparison(context, "WATER INTAKE", v1, v2, "ml", Colors.blueAccent));
    }
