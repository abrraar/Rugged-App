          ...
          if (hasSelection)
            Padding(
              ...
              child: Row(
                ...
                children: [
                  _buildStatMini("SLEEP DURATION", widget.data["duration"]?[_currentIndex], AppColors.crimson, isCompact),
                ],
              ),
            ),
                                                                      ...
                                                                      child: AnimatedContainer(
                                                                        ...
                                                                        child: Row(
                                                                          children: [
                                                                            ...
                                                                            SizedBox(width: isTimeSheetCompact ? 16.w : 12.0),
                                                                            Text(
                                                                              (use24HourClock ? DateFormat('HH:mm').format(dates[idx]) : DateFormat('hh:mm a').format(dates[idx])).toUpperCase(),
                                                                              style: AppTextStyles.labelSmall.adaptive(context).copyWith(
